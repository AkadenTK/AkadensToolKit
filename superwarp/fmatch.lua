...
-- this and the next are pretty much verbatim from https://www.lua.org/wshop12/Snyder1.pdf
...
-- wrote this myself based on https://en.wikipedia.org/wiki/Levenshtein_distance
